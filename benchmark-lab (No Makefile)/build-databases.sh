...
# Define paths
LAB_DIR=$(pwd)
RAW_DATA_DIR="$HOME/out-sf0.1/graphs/csv/raw/composite-projected-fk"
NEO4J_TARGET_DIR="$LAB_DIR/data/neo4j-sf0.1"
POSTGRES_TARGET_DIR="$LAB_DIR/data/postgres-sf0.1"
LDBC_PG_SCRIPTS="$HOME/ldbc_snb_interactive_impls/postgres/scripts"
